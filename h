...
Date:   Mon Apr 13 19:36:11 2026 +0800
    ...
    harness: adapt Claw One harness framework to mx-coder TypeScript project
    
    - Rewrite AGENTS.md for mx-coder (AI CLI session bridge with IM integration)
    ...
    - Add no-direct-sessions-modification.rule (mx-coder uses sessions.json)
...
Date:   Mon Apr 13 16:37:50 2026 +0800
    ...
    - Pre-warm: immediately spawn IM worker after 'mx-coder attach' exits
...
Date:   Sat Apr 11 22:41:32 2026 +0800
    ...
    Define requirements and design for mx-coder, a tool that bridges AI CLI
